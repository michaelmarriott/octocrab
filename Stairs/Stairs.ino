...
bool revesableOnColorWipeRain = false;
int twinkleAmounts = 3;
...
int pattern = 5; // What pattern playing boy?
...
int beginDelay = 100/divider;
int patternSpeed = 100/divider;
int shootingSpeed = 1000/divider;
int colourDelayLoop = beginDelay;
int twinkleSpeed = 10/divider;
...
#define SPARKING NUM_LEDS_PER_STRIP
...
void ColorWipeRainSequence(CRGB color, bool allowReverse, uint8_t wait) {
 ...
 //random16_add_entropy(random());
  ...
  trailMax = Increment(trailMax,4, 12,3);
  apart = Increment(apart,6, 20,4);
  amountOfAparts = Increment(amountOfAparts,5, 25,6);
